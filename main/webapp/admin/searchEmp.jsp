...
<html>
    ...
    <%
        ...
        ArrayList<EmployeeBean> Employees = empmodel.select();
    %>
    <body>
      ...
      <div class="container">
         ...
         <div class="container container1" style="margin-left: 220px;">
            ...
            <div class="iq-card-body">
                <form method="post" action="searchEmp.jsp" name="frm">

                  <div class="row">
                    <div class="col-md-1">
                      <div class="form-group" style="margin-top:30px;  margin-left:50px;">
                          <input class="form-control" id="rbtn3" name="r_btn" type="radio" value="rbtn1" checked>
                      </div>
                    </div>
            ...
            <% 
              ...
              if ("rbtn1".equals(request.getParameter("r_btn"))) {
                  er = emp.searchEmpBydetail(request.getParameter("search"));
                        ...
                        <tbody>
                            ...
                            <%
                                ...
                                for (EmployeeBean us : er) {
                                 if ((us.getFirst_name() == "") || (us.getDesignation() == "") || (us.getEmail() == "")) { 
                                %>
                             <td scope="col">----</td>
                                <%} else {%>
