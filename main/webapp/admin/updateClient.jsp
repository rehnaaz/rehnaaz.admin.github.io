...
<html>
    ...
    <%
        ClientModel empmodel = new ClientModel();
        AddClient bean = empmodel.selectById(request.getParameter("id"));
    %>
    <body>
                       ...
                       <div class="row">
                           <div class="col-md-3">
                               <div class="form-group">
                                   ...
                                   <input id="f_name" type="text" name="f_name" class="form-control shadow" 
                                          value="<%= (bean != null) ? bean.getF_name() : "" %>">
                               </div>
                           </div>
                           <div class="col-md-3">
                               <div class="form-group">
                       ...
                       <div class="row">
                           <div class="col-md-3">
                               <div class="form-group">
                                   ...
                                   <input id="mobile_no" type="text" name="mobile_no" class="form-control shadow" 
                           ...
                           <div class="col-md-3">
                               <div class="form-group">
                                   ...
                                   <input id="email" type="email" name="email" class="form-control shadow" 
                          ...
                          <div class="col-md-3">
                               <div class="form-group">
                                   <label for="requirement">Requirement</label>
                                    <input id="requirement" type="text" name="requirement" class="form-control shadow" 
                                           value="<%= (bean != null) ? bean.getRequire() : "" %>">
                               </div>
                           </div>
                         </div>
                         <div class="row">
                           ...
                           <div class="col-md-3">
                               <div class="form-group">
                                   ...
                                   <input id="address" type="text" name="address" class="form-control shadow" 
